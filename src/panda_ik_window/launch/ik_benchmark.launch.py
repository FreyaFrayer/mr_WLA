...
def generate_launch_description() -> LaunchDescription:
    ...
    # Now accepts ONLY a single integer window_size (>1).
    # Greedy baseline (ws=1) is evaluated automatically and recorded in summary.json.
    ...
    dp_dtype = LaunchConfiguration("dp_dtype")
    eval_workers = LaunchConfiguration("eval_workers")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("dp_dtype", default_value="float64"),
            DeclareLaunchArgument("eval_workers", default_value="1"),
